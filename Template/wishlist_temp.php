<?php 
  ...
  if($_SERVER['REQUEST_METHOD'])
  {
      ...
      if(isset($_POST['addCartfromWish'])){
        $deleteCart = $Cart->saveWishlist($_POST['item_id'],'cart', 'wishlist');
    }
  }
  ...
  <section id="cart" class="py-3">
    ...
    <div class="container-fluid w-75">
        <h5 class="font-size-20 font-rale">Danh sách yêu thích</h5>
        <div class="row">
        <!-- shopping detail -->
        ...
        $items =$product->getData('wishlist');
        ...
        <div class="row border-top py-3 mt-3">
            ...
            <div class="col-sm-8">
                ...
                <form method="post" >
                    <input type="hidden" name="item_id" value="<?=$item['item_id']?>">
                    <button type="submit" name="addCartfromWish" class="btn btn-success font-rale text-white px-3 ">Thêm vào giỏ hàng</button>
                    <!-- <button type="submit" class="btn btn-danger font-rale text-white px-3 border-right  " name="deleteCart" >Xóa</button> -->
                </form>
                </div>
                <!-- Product quantity -->
